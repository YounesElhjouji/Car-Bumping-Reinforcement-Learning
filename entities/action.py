...
class State:
    ...
    def to_list(self):
        ...
        return [self.x, self.y, self.vx, self.vy] + self.wall_sensors
    ...
    def from_list(lst):
        ...
        vy = lst[3]
        wall_sensors = lst[4:]
        return State(x, y, vx, vy, wall_sensors)
...
if __name__ == "__main__":
    ...
    state = State(x=1.0, y=2.0, vx=0.5, vy=-0.5, wall_sensors=[0.1, 0.2, 0.3, 0.4])
